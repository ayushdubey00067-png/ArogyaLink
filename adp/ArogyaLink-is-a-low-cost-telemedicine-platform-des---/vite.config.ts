...
// Dev helper plugins disabled if custom local plugins aren't present
const sourceMapperPlugin = null;
const devToolsPlugin = () => null;
const fullStoryPlugin = () => null;
const errorInterceptorPlugin = () => null;
const mediaVersionsPlugin = () => null;
